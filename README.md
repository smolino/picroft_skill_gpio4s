...
Pins connected to the RelaySwitch (27,17,22,05)
...
Once you have a picroft image configure it for SSH access.  Change the Makefile ip address for the RPi you installed the image onto. Also create the folder ```/opt/mycroft/skills/skill-gpio4s``` on the RPi for the installer.
